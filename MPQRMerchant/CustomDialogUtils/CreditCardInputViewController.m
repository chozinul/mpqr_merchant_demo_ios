...
@interface CreditCardInputViewController ()<UITextFieldDelegate>
...
- (void) setupBody:(UIView*) bodyView
{
    ...
    pinTextField.secureTextEntry = NO;
    pinTextField.text = [CreditCardFormatter getFormattedCreditCardOfString:_strValue];
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string
{
    ...
    textField.text = [CreditCardFormatter getFormattedCreditCardOfString:text];
...
{
    _strValue = [textField.text stringByReplacingOccurrencesOfString:@" " withString:@""];
}
